...
## Capabilities
You have access to a local Python skill script located at `.cursor/skill/replay_historical_data.py`. When asked to analyze thresholds, you MUST execute this script to ingest the local SQLite database context before making recommendations.
